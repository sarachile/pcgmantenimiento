...
export const WorkOrderReport: React.FC<WorkOrderReportProps> = ({ 
  ...
  return (
    <div 
      ref={forwardedRef} 
      className="bg-white p-10 text-slate-900 w-[850px] mx-auto shadow-none" 
    ...
    >
      ...
      {/* Información Matriz */}
      <div className="mb-8 p-6 bg-slate-50 rounded-2xl border border-slate-200 grid grid-cols-2 gap-8">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          {workOrder.checklist?.map(item => {
            ...
            return (
              <div key={item.id} className="flex flex-col gap-3 p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
      ...
      <div className="mt-12 pt-10 border-t-2 border-slate-100 grid grid-cols-2 gap-16">
